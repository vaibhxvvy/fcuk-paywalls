...
export function ExternalIcon(props: { className?: string }) {
  return <ExternalLink aria-hidden="true" className={props.className} />;
}
...
export function StarIcon(props: { className?: string }) {
  return <Star aria-hidden="true" className={props.className} />;
}

export function ChatIcon(props: { className?: string }) {
  return <MessageCircle aria-hidden="true" className={props.className} />;
}